...
int main(int argc, char *argv[]) {
    ...
    const double MMuAxion[2] = {MMU, EPS};
    ...
    for (auto iev = 0; event.Generate(), iev < nevent; ++iev) {
        ...
        tau1_decay.SetDecay(*tau1, 2, MMuAxion);  // --> mu + a
        ...
        auto axion = tau1_decay.GetDecay(1);
        // line 6
        ps.push_back(lhef::Particle(40, 1, 3, 3, 0, 0, axion->Px(), axion->Py(),
                                    axion->Pz(), axion->E(), axion->M(), 0, 0));
        ...
        auto nu1 = tau2_decay.GetDecay(1);
        // line 8
        ps.push_back(lhef::Particle(14, 1, 4, 4, 0, 0, nu1->Px(), nu1->Py(),
                                    nu1->Pz(), nu1->E(), nu1->M(), 0, 0));
        auto nu2 = tau2_decay.GetDecay(2);
        // line 9
        ...
        lhef::EventInfo evinfo(9, 9999, 0, 0, 0, 0);
