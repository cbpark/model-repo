...
export output_event_dir='/data/repo-om/Hhh_event/sm_event'
export output_log_dir='/data/repo-om/Hhh_event/sm_event/log'
...
# Main executable
./ttbar_cluster $output_event_dir/ttbar_$SGE_TASK_ID.lhe 10000 $SGE_TASK_ID $SGE_TASK_LAST > $output_log_dir/ttbar_$SGE_TASK_ID.log
